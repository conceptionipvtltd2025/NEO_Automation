...
// industries) plus the static brands module. Matching is field-weighted so a
// name hit outranks a description hit, and results group by type for the
...
const STATIC_ENTRIES: SearchEntry[] = [
  ...
  { id: "page:industries", title: "Industries", subtitle: "Sectors we power", href: "/industries", group: "Page", keywords: "industries sectors applications automotive aerospace data center electronics ev energy semiconductor wafer fab cleanroom metal fabrication welding heavy equipment machinery excavator home appliances white goods rail rolling stock trains trailers freight" },
  { id: "page:service", title: "Service", subtitle: "Neo Service Workshop — nut runners restored & certified", href: "/nsw", group: "Page", keywords: "nsw neo service workshop repair calibration service nut runner iso 6789 amc spares" },
  ...
  { id: "page:sustainability", title: "Sustainability & Safety", subtitle: "Our environmental and safety-first commitments", href: "/sustainability", group: "Page", keywords: "sustainability safety environment iso 14001 iso 45001 responsible sourcing circularity ergonomics esg community traceability green csr" },
  ...
  { id: "sec:home-industries", title: "Industries We Power", subtitle: "Built for the floors that build the world", href: "/#industries", group: "Section", keywords: "automotive aerospace data center electronics ev energy semiconductor metal fabrication heavy equipment home appliances rail rolling stock trailers" },
  { id: "sec:catalogue", title: "Our Catalogue", subtitle: "Precision tools for every process", href: "/#products", group: "Section", keywords: "catalogue categories tools products preview" },
  ...
  { id: "sec:torque-calibration", title: "Torque Calibration", subtitle: "ISO 6789 calibration & certification", href: "/nsw#torque-calibration", group: "Section", keywords: "calibration iso 6789 torque certificate audit" },
  ...
  { id: "sec:credentials", title: "Credentials & Certifications", subtitle: "Certified, authorised & accountable", href: "/about#credentials", group: "Section", keywords: "iso 9001 certification authorised distributor oem-trained credentials" },
