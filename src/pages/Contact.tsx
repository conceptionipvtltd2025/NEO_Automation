...
const mapsUrl = `https://www.google.com/maps/search/?api=1&query=${site.map.lat},${site.map.lng}`;
            ...
            <Reveal delay={0.2}>
              <div className="group relative mt-6 overflow-hidden rounded-3xl border border-white/10">
                <iframe
                  ...
                  src={`https://maps.google.com/maps?q=${site.map.lat},${site.map.lng}&z=14&output=embed`}
