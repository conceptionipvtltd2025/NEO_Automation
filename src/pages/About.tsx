...
const timeline = [
  { year: "2008", title: "Founded in Ahmedabad", text: "Neo Automation begins as a specialist supplier of precision assembly tools." },
          ...
          <div>
            <Reveal>
              <p className="text-lg leading-relaxed text-steel-300">
                Neo Automation Pvt. Ltd. is a trusted name in industrial
                automation and precision tooling. As the authorised distribution
                partner for global leaders, we deliver genuine products paired
                with deep technical know-how.
              </p>
            </Reveal>
            <Reveal delay={0.1}>
              <p className="mt-4 leading-relaxed text-steel-400">
                From a single workstation to a fully error-proofed assembly line,
                our team supports manufacturers at every step — specification,
                installation, integration, calibration and service.
              </p>
            </Reveal>
